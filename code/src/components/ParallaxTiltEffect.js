...
const ParallaxTiltEffect = () => {
  useEffect(() => {
    ...
    const wrap1 = new parallaxTiltEffect({
      element: document.querySelector('.wrap--1'),
      tiltEffect: 'reverse',
    });

    const wrap2 = new parallaxTiltEffect({
      element: document.querySelector('.wrap--2'),
      tiltEffect: 'normal',
    });

    const wrap3 = new parallaxTiltEffect({
      element: document.querySelector('.wrap--3'),
      tiltEffect: 'reverse',
    });
  }, []);
  ...
  return (
    <div>
      ...
      <a
        ...
        target="_blank"
      >
        abs/designs/d10-parallax-tilt-effect-cards
      </a>
    </div>
  );
};
